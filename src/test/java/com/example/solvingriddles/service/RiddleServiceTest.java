...
class RiddleServiceTest {
    ...
    void testCheckAnswerCorrect() {
        // 準備: Optionsはnull
        Riddle mockRiddle = new Riddle(1, "テスト問題", "Answer", "ヒント", "text", null,1);
    ...
    void testCheckAnswerWithOptions() {
        ...
        Riddle mockRiddle = new Riddle(4, "クリック問題", "found", "ヒント", "click", options,1);
    ...
    void testFindAll() {
        ...
        List<Riddle> mockList = List.of(
            new Riddle(1, "Q", "A", "H", "text", null, 1)
        );
