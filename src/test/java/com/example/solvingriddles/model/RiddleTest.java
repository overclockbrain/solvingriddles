...
class RiddleTest {
    ...
    void testDifficultyIconLevel1() {
        ...
        Riddle riddle = new Riddle(1, "Q", "A", "H", "text", null, 1);
    ...
    void testDifficultyIconLevel3() {
        Riddle riddle = new Riddle(1, "Q", "A", "H", "text", null, 3);
        assertEquals("★★★☆☆", riddle.difficultyIcon());
    }
    ...
    void testDifficultyIconLevel5() {
        Riddle riddle = new Riddle(1, "Q", "A", "H", "text", null, 5);
        assertEquals("★★★★★", riddle.difficultyIcon());
    }
    ...
    void testDifficultyIconNull() {
        // レベルに null を渡してみる
        Riddle riddle = new Riddle(1, "Q", "A", "H", "text", null, null);
